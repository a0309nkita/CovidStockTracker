...
<script 
	src="<c:url value="../resource/js/jquery.js"/>"></script>
...
<body ng-app="myapp">
	<div class="container" id="productTable"
		...
		<p><p style="margin-left: 90px;">The List of Products in our Database</p> <a href="<c:url value="/getAllProducts" />" class="btn btn-info"
									style="margin-top: -35px; width: 80px; float: right; margin-right: 1029px;">
					...
					<tr>
						...
						<td ng-controller="myController"><a
							...
							<!-- 						view only for user --> <security:authorize
								...
								<input id = "textbox_id1" name = "textbox_id1" ng-model="searchCondition" style = "width: 50px; length: 10px; margin-top: 10px"  type="text" placeholder="Count of Product">
								<a href="#" ng-click="addToCart1(${prod.productId}, searchCondition)"
