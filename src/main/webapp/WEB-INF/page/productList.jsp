...
function hello(){
	...
	if(x === ""){
		window.location = "http://localhost:8080/shopieasy/getAllProducts/"
		}
	else{
	window.location = "http://localhost:8080/shopieasy/getProductByName/" + x;
	}
}
</script>
</head>
<body ng-app="myapp">
	<div class="container" id="productTable"
		...
		Search: <input id = "textbox_id" name = "textbox_id" ng-model="searchCondition" type="text" placeholder="Search Product">
	<a id="regLink"
							onclick = "hello()" class="btn btn-primary" style="margin-left: 5px; margin-top: 2px"
