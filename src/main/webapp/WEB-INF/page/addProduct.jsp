				...
				<form:form method="post" action="${url}" commandName="productFormObj" enctype="multipart/form-data">
					<div class="col-sm-12">
						...
						<form:label path="productCategory">Product Category</form:label>
								 <form:radiobutton path="productCategory" value="Mask"/>Mask
								 <form:radiobutton path="productCategory" value="PPE Kit"/>PPE Kit
								 <form:radiobutton path="productCategory" value="Gloves"/>Gloves
								 <form:radiobutton path="productCategory" value="Sanitizers"/>Sanitizers
						</div>
						<div class="row">
