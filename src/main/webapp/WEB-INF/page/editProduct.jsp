				...
				<form:form method="post" action="${url}"
					...
					<div class="col-sm-12">
						...
						<div class="form-group">
							...
							<form:radiobutton path="productCategory" value="Mask" />
							Mask
							<form:radiobutton path="productCategory" value="PPE Kit" />
							PPE Kit
							<form:radiobutton path="productCategory" value="Gloves" />
							Gloves
							<form:radiobutton path="productCategory" value="Sanitizers" />
							Sanitizers
						</div>
						<div class="row">
