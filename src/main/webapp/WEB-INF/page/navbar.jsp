	...
	<div class="container-fluid">
		...
		<div class="nav navbar">
			<img class="navbar-brand"
				src="<c:url value="/resource/images/logo0.jpg"/>"
				href="<c:url value="/index"/>" width="150px" height="150px"
				alt="logo-image"></img>
		</div>
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<c:url value="/index1" />">Covid Stock Tracker</a>
		</div>
